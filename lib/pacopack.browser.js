(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.window = global.window || {}, global.perf_hooks));
})(this, (function (exports, perf_hooks) { 'use strict';
...
if (${v} >= 0x80) {
  ...
  function iterationOtimizerLoop(cb, ...args) {
      ...
      let iterations = 25;
      for (let i = 0; i < 25; i++) {
          let t = perf_hooks.performance.now();
          for (let ii = 0; ii < iterations; ii++) {
              cb(...args);
          }
          let dif = (perf_hooks.performance.now() - t) / (iterations / 25);
          if (!dif) {
              iterations *= 2;
              i--;
          }
  ...
  function stringIterationOtimizer(cbPrepare, cb1, cb2, ms, maxLength = Infinity) {
      ...
      while (true) {
          ...
          counter += 4;
          if ((perf_hooks.performance.now() - start > ms)) {
              break;
          }
      }
  ...
  exports.PacoPack = PacoPack;
  exports.UTF8 = UTF8;

  Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=pacopack.browser.js.map
